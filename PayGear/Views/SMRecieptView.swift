...
class SMRecieptView: UIView{
    ...
    func setupUI(){
		...
		saveReciept.setTitle("save.reciept".localized, for: .normal)
		closeReciept.setTitle("close.reciept".localized, for: .normal)
		titleLabel.text = "success.payment".localized
