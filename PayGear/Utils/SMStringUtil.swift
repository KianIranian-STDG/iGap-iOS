...
class SMStringUtil {
    ...
    static func getTransType(type : Int)->String{
        ...
        switch type {
        case 0:
            return "TRANSACTION_TYPE_DIRECTCARD".localized
        case 1:
            return "TRANSACTION_TYPE_CREDIT".localized
        case 2:
            return "TRANSACTION_TYPE_CASH".localized
        case 3:
            return "TRANSACTION_TYPE_POS".localized
