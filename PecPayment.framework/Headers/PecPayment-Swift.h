...
- (void)initCardToCardWithToken:(NSString * _Nonnull)Token MerchantVCArg:(UIViewController * _Nonnull)MerchantVCArg callback:(id <CardToCardResult> _Nonnull)callback SWIFT_METHOD_FAMILY(none);
...
@interface UIDevice (SWIFT_EXTENSION(PecPayment))
