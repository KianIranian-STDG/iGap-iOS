public struct DefaultAnimators {
    ...
    public var backgroundColorAnimator: CanAnimate = AnimatorZoomy(duration: 0.5, options: .curveLinear)
    
    public var dismissalAnimator: CanAnimate = AnimatorZoomy(duration: 0.2, options: .curveEaseInOut)
    
    public var positionCorrectionAnimator: CanAnimate = SpringAnimator(duration: 0.5)
    
    public var zoomAnimator: CanAnimate = AnimatorZoomy(duration: 0.4, options: .curveEaseInOut)
