...
class ClassicTheme: ThemeProtocol {
    ...
    var BorderCustomColor: UIColor = UIColor(named: "BorderCustomAlert")!
    ...
    var MessageUnreadCellBGColor: UIColor = UIColor(named: "IGMessageUnreadCellBGColor")!
    
    var ReceiveMessageBubleBGColor: UIColor = UIColor(named: "IGReceiveMessageBubleBGColor")!
    
    var SendMessageBubleBGColor: UIColor = UIColor(named: "IGSendMessageBubleBGColor")!
    
    var NavigationFirstColor: UIColor = UIColor(named: "IGNavigationFirstColor")!
    
    var NavigationSecondColor: UIColor = UIColor(named: "IGNavigationSecondColor")!
    ...
    var ButtonBGColor: UIColor = UIColor(named: "IGButtonBGColor")!
    
    var ButtonTextColor: UIColor = UIColor(named: "IGButtonTextColor")!
    ...
    var TabBarColor: UIColor = UIColor(named: "IGTabBarColor")!
    ...
    var NavigationButtonTextColor: UIColor = .black
