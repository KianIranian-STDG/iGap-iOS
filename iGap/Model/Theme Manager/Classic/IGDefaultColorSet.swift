...
class DefaultColorSet: DefaultColorSetProtocol {
    ...
    var SettingClassicBG: UIColor = UIColor(named: "SettingClassicBG")!
    ...
    var TabBarColor: UIColor = UIColor(named: "TabBarColorDefault")!

    var TabBarTextColor: UIColor = UIColor(named: "TabbarTextColorDefault")!

    var NavigationFirstColor: UIColor = UIColor(named: "NavigationFirstColorDefault")!
    
    var NavigationSecondColor: UIColor = UIColor(named: "NavigationSecondColorDefault")!

    var NavigationButtonTextColor: UIColor = UIColor(named: "NavigationButtonTextColorDefault")!

    var ReceiveMessageBubleBGColor: UIColor = UIColor(named: "ReceiveMessageBubleBGColorDefault")!

    var MessageUnreadCellBGColor: UIColor = UIColor(named: "MessageUnreadCellBGColorDefault")!

    var ButtonTextColor: UIColor = UIColor(named: "ButtonTextColorDefault")!

    var ButtonBGColor: UIColor = UIColor(named: "ButtonBGColorDefault")!

    var BorderCustomColor: UIColor = UIColor(named: "BorderCustomColorDefault")!
