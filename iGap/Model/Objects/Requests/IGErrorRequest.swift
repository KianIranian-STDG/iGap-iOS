...
enum IGError: String {
    ...
    case clientConditionOfflineSeenIsInvalid = "600.8"
...
class IGErrorRequest : IGRequest {
    class Handler : IGRequest.Handler{
        ...
        private class func showAlert(title: String? = nil, message: String? = nil, preferredStyle: UIAlertController.Style = IGGlobal.detectAlertStyle()){
