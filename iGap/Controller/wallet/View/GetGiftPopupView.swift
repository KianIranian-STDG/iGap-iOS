...
//        self.frame.size.height = 500.0
        ...
        self.TitleLabel.text = "barcode.gift.title".localizedNew
        self.ConfirmButton.setTitle("barcode.gift.confirm".localizedNew, for: .normal)
        self.ConfirmButton.setImage(nil, for: .normal)
        self.CancelButton.setTitle("barcode.gift.cancel".localizedNew, for: .normal)
