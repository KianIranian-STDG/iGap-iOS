//
//  SMGetAmountPopupView.swift
//  PayGear
//
//  Created by HSM on 2/7/19.
...
protocol SMGetAmountPopupDelegate {
    func dismissPopup()
}

// MARK: - extention to implement protocol method
/// Avoid crash when owner class is not implemented protocol method
extension SMGetAmountPopupDelegate {
    func dismissPopup() {
        // leaving this empty
    }
}

class SMGetAmountPopupView: UIView, SMStepperDelegate, UITextFieldDelegate, HandleDefaultCard {
    ...
    var delegate: SMGetAmountPopupDelegate!
    ...
    public var type: SMAmountPopupType = .PopupNoProductTaxi {
        didSet {
            if type == .PopupNoProductTaxi {
                ...
                popupHeightConstraint.constant = 363
            ...
            else if type == .HyperMe {
                popupHeightConstraint.constant = 273
                stepperHeightConstraint.constant = 0
    ...
    public var value: [String: String]! {
        didSet {
            ...
            if type == .PopupNoProductTaxi {
                ...
                if let price = value["price"]?.inRialFormat().inLocalizedLanguage() {
                    amountTF.text = price
                    amountTF.isEnabled = false
                }
            } else if type == .HyperMe {
            ...
            DispatchQueue.main.async {
                ...
                if self.value["imagePath"] != "" {
                    ...
                    self.merchantTypeLogo.image = #imageLiteral(resourceName: "user")
                }
    ...
    ///
    /// - Returns: instance of SMGetAmountPopupView
    class func loadFromNib() -> SMGetAmountPopupView {
        return UINib(nibName: "SMGetAmountPopupView", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! SMGetAmountPopupView
    }
    ...
    public override func layoutSubviews() {
        ...
        paymentTypeSwitch.titles = ["credit.wallet".localized ,"card.bank".localized]
