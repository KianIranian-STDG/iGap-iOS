...
class IGNavigationItem: UINavigationItem {
    ...
    //MARK: - Navigation VCs
    func addNavigationViewItems(rightItemText: String? = nil, rightItemFontSize: CGFloat = 25, title: String?, width: CGFloat = 150, iGapFont: Bool = false) {
        if title != nil {
...
//        addSettingButton()
    ...
    func initNavBarWithIgapIcon() {
        ...
        btnLogo.titleLabel?.font = UIFont.iGapFonticon(ofSize: 32)
