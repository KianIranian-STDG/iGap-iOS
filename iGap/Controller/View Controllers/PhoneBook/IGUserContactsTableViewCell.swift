...
class IGUserContactsTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        nameLbl.textColor = ThemeManager.currentTheme.LabelColor
        phoneNumberLbl.textColor = ThemeManager.currentTheme.LabelColor
        avatarIconLbl.textColor = ThemeManager.currentTheme.LabelColor
    }
