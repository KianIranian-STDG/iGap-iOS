...
class IGWallpaperPreview: UIViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        btnSet.setTitle(IGStringsManager.BtnSet.rawValue.localized, for: .normal)
    ...
    private func initNavigationBar(){
        ...
        navigationItem.addNavigationViewItems(rightItemText: nil, title: IGStringsManager.ChatBG.rawValue.localized, width: 250)
