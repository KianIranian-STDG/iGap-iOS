...
class IGSettingAccountBioTableViewController: UITableViewController , UIGestureRecognizerDelegate, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        navigationItem.addNavigationViewItems(rightItemText: IGStringsManager.GlobalDone.rawValue.localized, title: IGStringsManager.Bio.rawValue.localized)
        ...
        bioTextField.placeholder = IGStringsManager.Bio.rawValue.localized
