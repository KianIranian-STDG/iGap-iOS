...
class IGHelperToast {
    ...
    ///
    func showCustomToast(view: UIViewController? = nil, showCancelButton: Bool? = false, cancelTitleColor: UIColor = ThemeManager.currentTheme.NavigationFirstColor ,cancelBackColor : UIColor = UIColor.clear, message: String!, cancelText: String? = nil, cancel: (() -> Void)? = nil) {
