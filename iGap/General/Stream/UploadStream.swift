...
//            dt = fileHandler.readData(ofLength: 4096)
//            currentOffset += 4096
////            }
//            
//            if dt.count <= 0 {
...
//            
//                
////            try! encryptor?.update(withBytes: dt.bytes, isLast: false, output: {[weak self] (bytes) in
////                guard let sSelf = self else {
////                    return
////                }
////                print("=-=-=-=-=-=- XXXX1: ", bytes)
...
////
////                try! encryptor!.finish {[weak self] (bytes) in
////                    guard let sSelf = self else {
////                        return
////                    }
