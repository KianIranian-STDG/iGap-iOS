...
public class LocaleManager: NSObject {
    ...
    public static var isLanguageSelected: Bool {
        get {
            return UserDefaults.standard.bool(forKey: "isLanguageSelected")
        } set {
            UserDefaults.standard.set(newValue, forKey: "isLanguageSelected")
    ...
    public static var isRTL: Bool {
        get {
            return Locale.baseLocale.isRTL
        }
    }
    
    public static var semantic: UISemanticContentAttribute {
        get {
            return isRTL ? .forceRightToLeft : .forceLeftToRight
        }
    }
    
    public static var transform: CGAffineTransform {
        get {
            return isRTL ? CGAffineTransform(scaleX: -1, y: 1) : CGAffineTransform.identity
        }
    }
